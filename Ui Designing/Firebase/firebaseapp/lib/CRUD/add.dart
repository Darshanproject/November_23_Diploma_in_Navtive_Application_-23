...
CollectionReference students = FirebaseFirestore.instance.collection('students');
 Future<void> addusers(){
      ...
      .catchError((e)=>ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Something went Wrong $e",style: TextStyle(fontSize: 24),),backgroundColor: Colors.red,duration: Duration(minutes: 3),)))
      ;
    }
  @override
